# Graph Report - aic  (2026-05-07)

## Corpus Check
- 110 files · ~124,354 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1096 nodes · 1751 edges · 129 communities (95 shown, 34 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.72)
...
1. `ProximityDataGenerator` - 41 edges
2. `AicModel` - 23 edges
3. `TrainingFrameSink` - 20 edges
...
- `ProximityTeacher` --uses--> `MoveRobotCallback`  [INFERRED]
  aic_model/aic_model/policies/ProximityTeacher.py → /home/user/aic/aic_model/aic_model/policy.py
- `ProximityTeacher` --uses--> `Policy`  [INFERRED]
  aic_model/aic_model/policies/ProximityTeacher.py → /home/user/aic/aic_model/aic_model/policy.py
- `Tier 2 Scoring Topic Set` --shares_data_with--> `No-Contact SFP Standoff Baseline`  [INFERRED]
  aic_scoring/config/tier2.yaml → planning/sfp_visual_proximity_baseline_workflow.md
...
Cohesion: 0.09
Nodes (11): _decode_image_from_meta(), EpisodeSpec, _image_stats(), main(), _pose_to_dict(), _postprocess_episode_images(), ProximityDataGenerator, _rpy_to_quat() (+3 more)
...
Cohesion: 0.11
Nodes (31): Dataset, _autocast_context(), build_arg_parser(), build_model(), _build_port_instance(), build_samples_index(), _default_device(), evaluate_detector() (+23 more)
...
Cohesion: 0.2
Nodes (12): ACT-First Learned Policy Plan, DAgger Failure-Correction Loop, IsaacLab Non-Blocking Validation, Model-Agnostic Dataset Schema, MotionUpdate Velocity Command Pattern, Overall AIC Competition Plan, Proximity-First Scoring Strategy, No-Contact SFP Standoff Baseline (+4 more)
...
Cohesion: 0.2
Nodes (5): MoveRobotCallback, Move the robot using either Cartesian or joint-space commands.      This functio, Protocol, Policy that presses the arm into an enclosure wall using     joint-space control, WallPresser
...
Cohesion: 0.25
Nodes (9): add_cable_plugin Refinement Flow, Cartesian Keyboard Teleoperation Mode, Joint Keyboard Teleoperation Mode, aic_mujoco CMakeLists, aic_mujoco README, MuJoCo ros2_control Parity Path, SDF-to-MJCF Conversion Flow, aic_teleoperation File Manifest (+1 more)

### Community 38 - "Community 38"
Cohesion: 0.31
Nodes (9): aic_model Policy Framework, Example Policies README, Example Policies File Manifest, LeRobot ACT Policy Integration, Participant Model Component, AIC Toolkit Root README, RunACT Example Policy, Two-Component Toolkit Architecture (+1 more)
...
Cohesion: 0.38
Nodes (7): AIC Controller Impedance Settings, AIC Engine Orchestrator, aic_gz_bringup Launch Environment, aic_bringup CMakeLists, AIC ROS2 Controllers Config, aic_bringup README, Evaluation Component Stack

### Community 54 - "Community 54"
Cohesion: 0.29
Nodes (7): aic_engine CMakeLists, ROS-GZ Bridge Config, ROS-GZ Scoring/TF Bridge Topics, Tier 2 Scoring Config, Duplicate Tier 2 Entity Entries, Tier 2 Plug/Port Entity Pairs, Tier 2 Scoring Topic Set
...
Cohesion: 0.47
Nodes (6): CheatCode Ground-Truth Policy, ProximityTeacher Training Policy, SFP Visual Proximity Baseline Workflow, Task-Conditioned Candidate Selection, Training-Only Ground-Truth Labeling, Tri-Camera Keypoint Triangulation
...
- **Why does `ProximityDataGenerator` connect `Community 2` to `Community 0`?**
